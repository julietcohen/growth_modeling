...
forest_growth <- function(r = 0.01, C = 10, g = 2, K = 250) {
  early_growth = r*C
  late_growth = g*(1 - C/K)
  return(list(early_growth, late_growth))
}
```
...
```{r}
# time units = years
# make it a series of years rather than a static value so we can plot forest size at each time step
