...
parms <- c(r, K, g) # naomi did this in her code (https://naomitague.github.io/ESM232_course/lectures/lecture10_moredynamic.html#(7)), I am not sure how we should change this variable for our purposes
...
# Extract these values from C_over_time
...
#compute_metrics(sens_C) # i think this should work? but we need to run the ODE first if so
...
c_wrapper = function(r, g, K, C, simtimes, func) {
    parms = list(r = r, C = C, g = g, K = K, canopy_thresh = rep(50, length(r))) # confused where this length came from?
