...
static_parms <- c(r, K, g) # naomi did this in her code (https://naomitague.github.io/ESM232_course/lectures/lecture10_moredynamic.html#(7)), I am not sure how we should change this variable for our purposes

# **How does C know how to build on itself?**
# run the ODE solver
C_over_time = ode(y = 10, 
            times = simtimes, 
            func = C_growth,
            parms = static_parms)
...
c_wrapper = function(r, g, K, C, simtimes, func) {
    parms = list(r = r, C = C, g = g, K = K, canopy_thresh = rep(50, length(r)))
